...
//                            dos.flush();
    ...
    /*
     * Function  :   发送Post请求到服务器（提交数据）
     * Param     :   params请求体内容，encode编码格式
     */
    public static String submitPostData(Map<String, Object> params, String encode,String RequestURL) {
...
//            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
    ...
    public  static void post() {  
        ...
        HttpPost httpPost = new HttpPost("http://192.168.1.102:8080/uploadFile/up");  
