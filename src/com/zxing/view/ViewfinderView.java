...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			// 画扫描框边上的角，总共8个部分
			paint.setColor(getResources().getColor(R.color.cameraframe));
			...
			//
			// canvas.drawText(text1, (width - textWidth1)/2, (float)
			// (frame.bottom + (float)TEXT_PADDING_TOP *density*2), paint);
